...
Команда может быть полноценным shell-скриптом, начинающимся с заголовка `#!`, в этом случае так же допустимо использование шаблонов, за исключением математических выражений.
