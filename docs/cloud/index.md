...
_HOMEd Cloud_ это сервис, который позволяет "пробрасывать" устройства в [Умный дом Яндекса](https://alice.yandex.ru/smart-home) и управлять ими с помощью Алисы или из приложения.
