...
!!! warning ""
    ...
    Карта регистров работает только для [устройств](/modbus/devices/) типа `customController`. Карта регистров поддерживает только [типовые способности](/common/exposes/#_1) устройств. Специальные способности не поддерживаются.
